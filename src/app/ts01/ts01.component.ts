...
export class Ts01Component {
  ...
  variables():void{ //void es el retorno
    let hello = "Hello World";
    let a; //tipo desconocido, valen todos 
    const PI = 3.1416;
    console.log(PI);
    a = "kenai";
    console.log(a);
    ...
    console.log(bandera);
    let b:string="hola";
    let c:boolean | number; // la variable c tiene 2 tipos
    c = false
  }
  ...
  tipoString():void{
    ...
    //se puede concatenar como en kotlin "$()"
    //se puede usar metodos como length, toLowerCase...
  }
